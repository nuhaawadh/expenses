...
const ar = {
  ...
  form: {
    dateLabel: "اختر اليوم",
    timeLabel: "اختر الوقت",
    timezone: "بتوقيت الرياض",
    noDate: "اختر يومًا أولًا لعرض الأوقات.",
    details: "بياناتك",
    name: "الاسم الكامل",
    ...
    teamSize: "حجم الفريق",
    teamOptions: ["1–10 موظفين", "11–50 موظفًا", "51–200 موظف", "أكثر من 200 موظف"],
    choose: "اختر",
    message: "أين يقصّر الذكاء الاصطناعي في شركتك حاليًا؟ (اختياري)",
    submit: "تأكيد طلب الحجز",
    sending: "جارٍ الإرسال…",
    required: "هذا الحقل مطلوب.",
    invalidEmail: "أدخل بريدًا إلكترونيًا صحيحًا.",
    invalidPhone: "أدخل رقم جوال صحيحًا.",
    pickSlot: "اختر اليوم والوقت المناسبين.",
    errorGeneric: "تعذّر إرسال الطلب. حاول مرة أخرى بعد قليل.",
    errorOffline: "خدمة الحجز غير متصلة بعد. تواصل معنا عبر البريد الإلكتروني.",
    previewNote: "هذه نسخة معاينة، لذلك لم يُرسَل الطلب.",
    successTitle: "استلمنا طلبك",
    successBody: "سنتواصل معك لتأكيد الموعد:",
...
const en: Content = {
  ...
  form: {
    ...
    noDate: "Pick a day first to see available times.",
    ...
    choose: "Choose",
    message: "Where is AI falling short in your business today? (optional)",
    submit: "Confirm booking request",
    sending: "Sending…",
    required: "This field is required.",
    invalidEmail: "Enter a valid email address.",
    invalidPhone: "Enter a valid mobile number.",
    pickSlot: "Pick a day and time that suit you.",
    errorGeneric: "We couldn't send your request. Please try again shortly.",
    errorOffline: "Booking isn't connected yet. Please contact us by email.",
    previewNote: "This is a preview, so the request was not sent.",
    successTitle: "We've got your request",
    successBody: "We'll be in touch to confirm your call:",
