...
const PHASES = [
  {
    ...
    steps: ["Map the business.", "Find the bottlenecks.", "Document the processes."],
  },
  {
      ...
      <div className="frame grid gap-16 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-6">
          <div className="lg:sticky lg:top-36">
            <Reveal>
              <Eyebrow index="07">The HIGHLink method</Eyebrow>
            </Reveal>
            <SplitHeadline
              id="method-title"
              lines={["We Don’t Start", "With AI."]}
              className="t-display-sm mt-8"
            />
            <SplitHeadline
              as="p"
              delay={0.2}
              lines={["We Start With", "Your Business."]}
              className="t-display-sm mt-2 text-mute"
            />
            <Reveal delay={0.2}>
              <p className="t-lead pretty mt-10 max-w-md">
                We’re not here to sell you tools. Technology is the last decision, not the first — every agent and
                automation we build is designed around how your company actually runs.
              </p>
            </Reveal>
          </div>
        </div>
