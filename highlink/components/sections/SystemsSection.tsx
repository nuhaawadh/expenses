      ...
      <div className="frame">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-8">
            ...
            <SplitHeadline
              id="systems-title"
              lines={["One System.", "Every Part of Your Business."]}
              dimFrom={1}
          ...
          <Reveal delay={0.15} className="lg:col-span-4">
            <p className="t-lead pretty">
              Five connected systems that share one brain — so every part of your business moves with the same
              context.
            </p>
          </Reveal>
        </div>
              ...
              <Reveal as="li" key={s.name} delay={i * 0.06} className="border-t border-line-2">
                <h3>
                  <button
                    ...
                    className="group grid w-full grid-cols-[2.5rem_1fr_auto] items-center gap-3 py-6 text-left md:grid-cols-12 md:gap-10 md:py-9"
                  >
                    <span
  ...
  return (
    <div className="pb-10 md:grid md:grid-cols-12 md:gap-10 md:pb-14">
      <ol className="relative md:col-span-10 md:col-start-3 md:grid md:grid-cols-5">
        ...
        <motion.span
          aria-hidden
          className="absolute left-[5px] top-2 bottom-2 w-px origin-top bg-gradient-to-b from-accent/70 to-accent/10 md:left-0 md:right-0 md:top-[5px] md:bottom-auto md:h-px md:w-auto md:origin-left md:bg-gradient-to-r"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        {steps.map((step, j) => (
          <motion.li
            key={step}
            className="relative flex items-center gap-5 py-2.5 pl-0 md:block md:py-0 md:pr-4"
          ...
          >
            ...
            <span className="md:mt-6 md:block">
              <span className="mr-3 font-mono text-[10px] tracking-[0.18em] text-dim md:mb-2 md:mr-0 md:block">
